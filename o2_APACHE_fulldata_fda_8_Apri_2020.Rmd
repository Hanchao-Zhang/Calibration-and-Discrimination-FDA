---
title: "Whole data Functional data analysis for o2 adjusted by APACHE"
output:
  html_document:
    toc: true
    toc_float: true
...
auc_estimation <- function(data = dat_o2_grouped, k = 5, y = 'ROSC', x = 'fd'){
...
auc_list <- foreach(x=loop_indx1,.packages=c('tidyverse', 'pROC')) %dopar% {
  ...
  replicate(50,{
  auc_estimation(data = dat_o2_grouped, k = 5, y = 'ROSC', x = 'perc')
  })
...
## Analysis I - One variable adjusted by APACHE
 
### CPR duration adjusted by APACHE
...
### CPR duration above o2 level adjusted by APACHE
...
### Derivatives adjusted by APACHE
...
### Number of tunning points adjusted by APACHE
...
## Analysis II - Two variable adjusted by APACHE

### mean o2 and CPR duration adjusted by APACHE
...
### mean o2 and derivatives adjusted by APACHE
...
### mean o2 and tunning points adjusted by APACHE
...
### CPR duration and derivatives adjusted by APACHE
...
### CPR duration and turning points adjusted by APACHE
...
### CPR duration above o2 level and derivatives adjusted by APACHE
...
### Analysis III - Three variable adjusted by APACHE




### mean o2, CPR duration and derivatives adjusted by APACHE
 
```{r}
var_int = names(dat_o2_grouped_demographic)[grep('duration', names(dat_o2_grouped_demographic))]
var_adj = c('APACHE', 'fd', 'mean_o2')
y = 'survival'
cv_pred_err <- cv_prediction_err(data = dat_o2_grouped_demographic, var_int = var_int, var_adj = var_adj, y = y, cv.seed = 456)
```
